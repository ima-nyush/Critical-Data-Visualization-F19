...
function updateButtons(){
  d3.shuffle(data1);
  document.getElementById("data1button").innerHTML = JSON.stringify(data1).replace(/{/g, "</br>{").replace("[", "").replace("]", "").replace("A", "<b>A</b>").replace("C", "<b>C</b>").replace("D", "<b>D</b>").replace("Z", "<b>Z</b>").replace("B", "<b>B</b>");


  d3.shuffle(data2);
  document.getElementById("data2button").innerHTML = JSON.stringify(data2).replace(/{/g, "</br>{").replace("[", "").replace("]", "").replace("A", "<b>A</b>").replace("C", "<b>C</b>").replace("D", "<b>D</b>").replace("Z", "<b>Z</b>").replace("B", "<b>B</b>");

  d3.shuffle(data3);
  document.getElementById("data3button").innerHTML = JSON.stringify(data3).replace(/{/g, "</br>{").replace("[", "").replace("]", "").replace("A", "<b>A</b>").replace("C", "<b>C</b>").replace("D", "<b>D</b>").replace("Z", "<b>Z</b>").replace("B", "<b>B</b>");
}
updateButtons();
