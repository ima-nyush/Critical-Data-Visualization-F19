## Lab 7 - Dynamic Visualization Part 2

Today we learn more about the
- update
- enter
- exit
concept in D3.

Start with [these files](material/lab7-start.zip). We will build this:
